...
public class AudioContentStore
{
		...
		public AudioContentStore()
		{
		  ...
		  // Create some songs audiobooks and podcasts and to store
			...
			seasons=makeSeasons();
			String podcastAudioFile=""; // create complete podcast audio file
			for (int i=0;i<seasons.size();i++) {
				podcastAudioFile+=seasons.get(i).getAudioFile();
			}
			
			Podcast pod=new Podcast("The Secret Life of Canada", "865", 2021, Podcast.TYPENAME, podcastAudioFile,0, "Leah-Simone Bowen, Falen Johnson", seasons); // copied from video
		...
		private ArrayList<Season> makeSeasons() // this was modified to work with my Seasons class
		{
			ArrayList<Season> seasons = new ArrayList<Season>();
			ArrayList<String> episodeTitles=new ArrayList<String>();
			ArrayList<String> episodes=new ArrayList<String>();
			ArrayList<Integer> episodeLengths = new ArrayList<Integer>();
			episodeTitles.add("Bay Blanket");
			episodeTitles.add("You Don't Want to Sleep Here");
			episodeTitles.add("The Gold Rush");
			episodes.add("The Bay Blanket. These warm blankets are as iconic as Mariah Carey's \r\n"
			...
			episodes.add("There is no doubt that the Klondike Gold Rush was an iconic event. \r\n"
			...
			episodes.add("here is no doubt that the Klondike Gold Rush was an iconic event. \r\n"
			  		+ "But what did the mining industry cost the original people of the territory? \r\n"
			  		+ "And what was left when all the gold was gone? And what is a sour toe cocktail?");
			episodeLengths.add(31);
			episodeLengths.add(32);
			episodeLengths.add(45);
		  Season s1 = new Season(episodes, episodeTitles, episodeLengths);
		  seasons.add(s1);
		  
		  ArrayList<String> episodeTitles2=new ArrayList<String>();
			ArrayList<String> episodes2=new ArrayList<String>();
			ArrayList<Integer> episodeLengths2 = new ArrayList<Integer>();
		  episodeTitles2.add("Toronto vs Everyone");
		  episodeTitles2.add("Water");
		  episodes2.add("There is no doubt that the Klondike Gold Rush was an iconic event. \r\n"
		  		+ "But what did the mining industry cost the original people of the territory? \r\n"
		  		+ "And what was left when all the gold was gone? And what is a sour toe cocktail?");
		  episodes2.add("Can the foundation of Canada be traced back to Indigenous trade routes?\r\n"
		  		+ "In this episode Falen and Leah take a trip across the Great Lakes, they talk corn\r\n" // this line and the next one had an extra space at the beginning of the string.
		  		+ "and vampires, and discuss some big concerns currently facing Canada's water.");  // I removed the space to match the video
		  episodeLengths2.add(45);
		  episodeLengths2.add(50);
		  Season s2 = new Season(episodes2, episodeTitles2, episodeLengths2);
		  seasons.add(s2);
		  return seasons;
		}
